...
create_logger = CreateLogger("MainDistributePicturesSD35")
logger = create_logger.return_logger()



class MainDistributePicturesSD35:
    def __init__(self, source_folder, destination_folder, train_ratio=0.8):
        ...
        self.train_folder = os.path.join(destination_folder, "tech_train_SD35")
        self.test_folder = os.path.join(destination_folder, "tech_eval_SD35")
...
if __name__ == "__main__":
    distribution = MainDistributePicturesSD35(
