...
class MainAnalysis2:
    ...
    def __call__(self):
        ...
        plot_dir = "/scicore/home/bruder/behleo00/PA/src/main/resources/data/results1day/plots"
        ...
        # save results
        results = {'errs': validationerrs, 'losses': trainingslosses, 'valid_losses': valid_losses}
        self.save_model(model)

        saver = SaveResults()
        saver.save_as_csv(results)
        saver.save_each_as_csv(results)


    def save_model(self, model, model_name="trained_model"):
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        model_dir = "/scicore/home/bruder/behleo00/PA/src/main/resources/data/results1day/"
