...
create_logger = CreateLogger("MainAnalysisFX1")
logger = create_logger.return_logger()

class MainAnalysisFX1:
    def __init__(self):
        try:
            logger.info("Initializing starts")
            self.TRAIN_FOLDER = "/scicore/home/bruder/behleo00/PA/src/main/resources/data/pictures/tech_train_FX1"
            self.EVAL_FOLDER = "/scicore/home/bruder/behleo00/PA/src/main/resources/data/pictures/tech_eval_FX1"
    ...
    def __call__(self):
        ...
        plot_dir = "/scicore/home/bruder/behleo00/PA/src/main/resources/data/results1dayFX1/plots"
        ...
        # save results
        resultsFX1 = {'errs': validationerrs, 'losses': trainingslosses, 'valid_losses': valid_losses}
        self.save_model(model)

        saver = SaveResults()
        saver.save_as_csv(resultsFX1)
        saver.save_each_as_csv(resultsFX1)


    def save_model(self, model, model_name="trained_model"):
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        model_dir = "/scicore/home/bruder/behleo00/PA/src/main/resources/data/results1dayFX1/"
